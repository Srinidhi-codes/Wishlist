...
export default function Sidebar() {
  ...
  return (
    <aside className={`shadow-sidebar h-full font-secondary-font bg-[#F8FAFC] custom-scrollbar md:flex hidden items-center flex-col gap-2 px-5 py-5 ${toggleSidebar ? "w-20" : "w-72"}`}>
